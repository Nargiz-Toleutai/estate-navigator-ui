                ...
                <div className={styles.container}>
                    <div className={styles.bannerContent}>
                        <div className={styles.bannerInfo}>
                            ...
                            <div>
                                <span>Отчет за 15 секунд&nbsp;
                                    <br/>Результат — <span>за 0 ₽</span>
                                </span>
                            </div>
                            <CommonButton link="#search">
                                Проверить
                            </CommonButton>
                        </div>
                        <div className={styles.bannerMedia}>
                            <video playsInline autoPlay loop muted preload="auto" controlsList="nodownload">
                                <source
                ...
                <div className={styles.container}>
                    <div className={styles.workContent}>
                        <div className={styles.workInfo}>
                            ...
                            <ul>
                                {['Выбирете доступное помещение под аренду или покупку на Авито', 'Вставьте ссылку на объявление в поле поиска', 'Получите отчет со всеми данными за 15 секунд'].map((action, index) => (
                ...
                <div className={styles.container}>
                    <div className={styles.searchContent}>
                        ...
                        <form onSubmit={onSubmit}>
                            <input type="text" placeholder="Ссылка на объявление в Avito" name="url"/>
                            ...
                            {[
                                {
                                    ...
                                    answer: '7 из 10 ПВЗ закрываются через 6 месяцев после открытия или работают с около нулевой доходностью. Это связано с тем, что не проверив локацию многие будущие владельцы не понимают всех рисков и подводных камней этого бизнеса. Perfect Point  помогает принимать взвешенные решения и выбрать лучшее точку для открытия, сэкономив время и деньги при анализе выбранного помещения/локации'
                                },
                                {
                                    question: 'Что будет в отчете?',
                                    answer: '• доступность открытия ПВЗ по адресу помещения на Авито<br/>• соответствие помещения требованиям франшиз WB, OZON и YMarket<br/>• отдаленность от существующих ПВЗ в локации открытия'
                                },
                                {
                                    question: 'Почему я могу доверять результатам вашей оценки?',
                                    answer: 'Мы анализируем более 20 источников данных и используем <b>AI-инструменты</b>, чтобы предоставить максимально достоверную и независимую оценку перспективности открытия ПВЗ'
                                },
                                {
                                    question: 'Почему только Авито?',
                                    answer: 'В данный момент мы находится на стадии бета-тестирования и работаем над расширением функционала сервиса PerfectPoint'
                                },
                                {
                                    question: 'К кому я могу обратиться и задать вопросы о сервисе?',
                                    answer: 'Напишите нам на почту perfectpoint@gmail.com, и мы с радостью ответим на ваши вопросы'
                                },
                                {
                                ...
                                <details key={index} name="faq">
                                    <summary><h4>{faq.question}</h4></summary>
